      ...
      <div className="flex flex-col justify-between w-full min-h-screen">
                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                  <div className="flex justify-between h-16">
                    <div className="flex">
                      <Link
                        href={"/"}
                        className="flex items-center flex-shrink-0 text-lg font-bold"
                      >
                        PKG RC
                      </Link>
        ...
        <footer className="bg-white">
          <div className="mx-4 lg:mx-12">
            <p className="py-6 text-base text-center text-gray-400 border-t">
              &copy; { new Date().getFullYear() } PKG RC. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
